...
def create_org_wordlist(name, dob):
  ...
  # Loop through the date of birth parts and add them to the wordlist
  ...
  for i in range(len(name_parts)):
    for j in range(len(dob_parts)):
      ...
      wordlist.append(name_parts[i] + dob_parts[j])
...
def create_person_wordlist(name, dob):
  ...
  for i in range(len(nick_parts)):
    for j in range(len(dob_parts)):
      # Add the name part followed by the date of birth part, db, yob and yob_full
      wordlist.append(nick_parts[i] + dob_parts[j])
  ...
  for i in range(len(nick_parts)):
    for j in range(len(dob_parts)):
      # Add the name part followed by the date of birth part, db, yob and yob_full
      wordlist.append(dob_parts[j] + nick_parts[i])
...
if type == "o":
  ...
  print("Here is your wordlist:")
  print(wordlist) # change this to file creation with date
  exit
######################
# Personal Questions #
######################
  ...
  wordlist = create_person_wordlist(name, dob)
  print("Here is your wordlist:")
  print(wordlist) # change this to file creation with date
  exit
else:
